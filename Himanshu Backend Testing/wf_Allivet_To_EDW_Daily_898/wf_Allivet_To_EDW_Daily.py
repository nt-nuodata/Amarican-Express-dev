...
df_0 = spark.sql("""SELECT
  ALLIVET_ORDER_NBR_v2_testing AS ALLIVET_ORDER_NBR,
  ALLIVET_ORDER_LN_NBR_v2_testing AS ALLIVET_ORDER_LN_NBR,
  ALLIVET_ORDER_DT AS ALLIVET_ORDER_DT,
  PETSMART_ORDER_DT AS PETSMART_ORDER_DT,
  ORDER_STATUS_v2_testing AS ORDER_STATUS,
  PRODUCT_ID_v3_testing AS PRODUCT_ID,
  ...
  SHIP_METHOD_CD_v2_testing AS SHIP_METHOD_CD,
  ...
  SHIP_HOLD_DT_v2_testing AS SHIP_HOLD_DT,
...
FROM
  ALLIVET_ORDER_DAY_v2_testing_v3_testing""")
