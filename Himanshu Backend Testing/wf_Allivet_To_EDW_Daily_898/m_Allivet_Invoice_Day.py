...
df_2 = spark.sql("""SELECT
  ...
  INVOICE_CODE_V22_test AS INVOICE_CODE,
  ...
  PETSMART_SKU_V2_test AS PETSMART_SKU,
  UPC AS UPC,
...
# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_ALLIVET_DAILY_INVOICE_PRE
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_SKU_PROFILE
...
# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_SKU_PROFILE
...
spark.sql("""MERGE INTO ALLIVET_INVOICE_DAY_V2_test AS TARGET
USING
  UPDTRANS_10 AS SOURCE ON TARGET.INVOICE_CD = SOURCE.INVOICE_CODE
