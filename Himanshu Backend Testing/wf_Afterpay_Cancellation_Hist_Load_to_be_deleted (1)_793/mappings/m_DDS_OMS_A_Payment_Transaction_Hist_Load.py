...
# COMMAND ----------
# DBTITLE 1, A_PAYMENT_TRANSACTION_0
...
df_0.createOrReplaceTempView("A_PAYMENT_TRANSACTION_0")
...
df_1=spark.sql("""
    SELECT
        ...
        Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        A_PAYMENT_TRANSACTION_0 
    WHERE
        (
            A_PAYMENT_TRANSACTION.TRANSACTION_DTTM >= current_timestamp - 120
        ) 
        OR (
            A_PAYMENT_TRANSACTION.CREATED_DTTM >= current_timestamp - 120
        )""")

df_1.createOrReplaceTempView("SQ_Oracle_A_PAYMENT_TRANSACTION_1")

# COMMAND ----------
# DBTITLE 1, OMS_A_PAYMENT_TRANSACTION_2
...
df_2.createOrReplaceTempView("OMS_A_PAYMENT_TRANSACTION_2")
...
df_4=spark.sql("""
    ...
    LEFT JOIN
        SQ_Oracle_A_PAYMENT_TRANSACTION_1 DETAIL 
            ON MASTER.OMS_PAYMENT_TRANSACTION_ID = DETAIL.PAYMENT_TRANSACTION_ID""")
...
spark.sql("""INSERT INTO OMS_A_PAYMENT_TRANSACTION SELECT PAYMENT_TRANSACTION_ID AS OMS_PAYMENT_TRANSACTION_ID,
EXTERNAL_PAYMENT_TRANS_ID AS EXTERNAL_PAYMENT_TRANS_ID,
COMPANY_ID AS COMPANY_ID,
PAYMENT_TRANS_TYPE AS PAYMENT_TRANS_TYPE,
PAYMENT_DETAIL_ID AS PAYMENT_DETAIL_ID,
...
OMS_LAST_UPDATED_DTTM AS OMS_LAST_UPDATED_DTTM,
UPDATED_DTTM AS UPDATED_DTTM,
LOAD_TSTMP AS LOAD_TSTMP FROM UPD_Insert_Update_Records_7""")