...
# COMMAND ----------
# DBTITLE 1, Allivet_Daily_Order_0
...
df_0.createOrReplaceTempView("Allivet_Daily_Order_0")
...
df_2=spark.sql("""
    SELECT
        AllivetOrderCode AS AllivetOrderCode,
        PetsmartOrderCode AS PetsmartOrderCode,
        TO_DATE(AllivetOrderDate,
        'MM-DD-YYYY HH12:MI:SSAM') AS o_AllivetOrderDate,
        TO_DATE(PetsmartOrderDate,
        'MM-DD-YY HH24:MI') AS o_PetsmartOrderDate,
        Subtotal AS Subtotal,
        Freight AS Freight,
        Total AS Total,
        ShippingMethodCode AS ShippingMethodCode,
        OrderStatus AS OrderStatus,
        IFF(Upper(IsVoided) = 'FALSE',
        '0',
        IFF(Upper(IsVoided) = 'TRUE',
        '1',
        IsVoided)) AS o_IsVoided,
        IFF(Upper(IsOnHold) = 'FALSE',
        '0',
        IFF(Upper(IsOnHold) = 'TRUE',
        '1',
        IsOnHold)) AS o_IsOnHold,
        TO_DATE(SalesOrderDateCreated,
        'MM-DD-YYYY HH12:MI:SSAM') AS o_SalesOrderDateCreated,
        TO_DATE(SalesOrderDateModified,
        'MM-DD-YYYY HH12:MI:SSAM') AS o_SalesOrderDateModified,
        TO_DATE(DateShipped,
        'MM-DD-YYYY HH12:MI:SSAM') AS o_DateShipped,
        IFF(Upper(IsShipped) = 'FALSE',
        '0',
        IFF(Upper(IsShipped) = 'TRUE',
        '1',
        IsShipped)) AS o_IsShipped,
        InternalNotes AS InternalNotes,
        PublicNotes AS PublicNotes,
        AutoShip_DiscountAmount AS AutoShip_DiscountAmount,
        OrderMerchantNotes AS OrderMerchantNotes,
        IFF(Upper(IsRiskOrder) = 'FALSE',
        '0',
        IFF(Upper(IsRiskOrder) = 'TRUE',
        '1',
        IsRiskOrder)) AS o_IsRiskOrder,
        RiskReasons AS RiskReasons,
        OriginalShippingMethodCode AS OriginalShippingMethodCode,
        IFF(Upper(IsShipHold) = 'FALSE',
        '0',
        IFF(Upper(IsShipHold) = 'TRUE',
        '1',
        IsShipHold)) AS o_IsShipHold,
        TO_DATE(DateShipHold,
        'MM-DD-YYYY HH12:MI:SSAM') AS o_DateShipHold,
        TO_DATE(DateShipReleased,
        'MM-DD-YYYY HH12:MI:SSAM') AS o_DateShipReleased,
        AllivetSku AS AllivetSku,
        PetsmartSku AS PetsmartSku,
        LineNum AS LineNum,
        QuantityOrdered AS QuantityOrdered,
        ItemDescription AS ItemDescription,
        ExtPrice AS ExtPrice,
        TO_DATE(CustomerSalesOrderDetailDateCreated,
        'MM-DD-YYYY HH12:MI:SSAM') AS o_CustomerSalesOrderDetailDateCreated,
        TO_DATE(CustomerSalesOrderDetailDateModified,
        'MM-DD-YYYY HH12:MI:SSAM') AS o_CustomerSalesOrderDetailDateModified,
        HowdowegetyoutRx AS HowdowegetyoutRx,
        VetCode AS VetCode,
        PetCode AS PetCode,
        IFF(Upper(IsOnHold1) = 'FALSE',
        '0',
        IFF(Upper(IsOnHold1) = 'TRUE',
        '1',
        IsOnHold1)) AS IsShipHold,
        IFF(Upper(IsOnHoldToFill_C) = 'FALSE',
        '0',
        IFF(Upper(IsOnHoldToFill_C) = 'TRUE',
        '1',
        IsOnHoldToFill_C)) AS IsOnHoldToFill_C1,
...
spark.sql("""INSERT INTO ALLIVET_DAILY_ORDER_PRE SELECT AllivetOrderCode AS ALLIVET_ORDER_CODE,
