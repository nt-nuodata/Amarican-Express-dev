...
# COMMAND ----------
# DBTITLE 1, Allivet_Daily_Invoice_0
...
df_0.createOrReplaceTempView("Allivet_Daily_Invoice_0")
...
df_2=spark.sql("""
    SELECT
        ...
        To_date(InvoicePostingDate,
        'YYYY-MM-DD') AS o_InvoicePostingDate,
        InvoiceCode AS InvoiceCode,
        TransactionType AS TransactionType,
        Allivet_Order AS Allivet_Order,
        PetSmart_Order AS PetSmart_Order,
        ...
        DispensingFee AS DispensingFee,
        to_date(shipped_on,
        'YYYY-MM-DD HH24:MI:SS.MS') AS o_shipped_on,
        fulfillment_origin_zip_code AS fulfillment_origin_zip_code,
        shipping_carrier AS shipping_carrier,
        TrackingNumber AS TrackingNumber,
        Customer_id AS Customer_id,
        ...
        Pet_gender AS Pet_gender,
        TO_DATE(pet_DOB,
        'YYYY-MM-DD') AS o_pet_DOB,
        Pet_weight AS Pet_weight,
        Pet_allergy AS Pet_allergy,
        Pet_medical_conditions AS Pet_medical_conditions,
        IFF(ISNULL(Pet_is_pregnant),
        NULL,
        IFF(UPPER(Pet_is_pregnant) = 'Y',
        1,
        IFF(UPPER(Pet_is_pregnant) = 'N',
        0,
        false))) AS o_Pet_is_pregnant,
        Vet_clinic_name AS Vet_clinic_name,
        Veterinary_name AS Veterinary_name,
        Vet_address AS Vet_address,
        Vet_city AS Vet_city,
...
spark.sql("""INSERT INTO ALLIVET_DAILY_INVOICE_PRE SELECT o_InvoicePostingDate AS INVOICE_POSTING_DATE,
...
Vet_zip AS VET_ZIP,
Vet_phone_number AS VET_PHONE_NUMBER,
LOAD_TSTMP AS LOAD_TSTMP FROM Exp_LoadTstmp_2""")