...
# COMMAND ----------
# DBTITLE 1, ALLIVET_INVOICE_DAY_0
...
df_0.createOrReplaceTempView("ALLIVET_INVOICE_DAY_0")
...
df_2.createOrReplaceTempView("ALLIVET_DAILY_INVOICE_PRE_2")
...
df_6=spark.sql("""
    ...
    LEFT JOIN
        SQ_Shortcut_to_ALLIVET_DAILY_INVOICE_PRE_3 DETAIL 
...
df_7=spark.sql("""
    ...
    LEFT JOIN
        Jnr_SKU_Profile_6 DETAIL 
            ON MASTER.INVOICE_POSTING_DT = INVOICE_POSTING_DATE 
            AND LKP_INVOICE_CD = INVOICE_CODE 
            AND LKP_TXN_TYPE = TRANSACTION_TYPE 
            AND LKP_ALLIVET_ORDER_NBR = ALLIVET_ORDER_CODE 
            AND LKP_ALLIVET_SKU_NBR = DETAIL.ALLIVET_SKU""")
...
df_8=spark.sql("""
    SELECT
        ...
        IFF((ISNULL(LKP_INVOICE_POSTING_DT) 
...
spark.sql("""INSERT INTO ALLIVET_INVOICE_DAY SELECT INVOICE_POSTING_DATE AS INVOICE_POSTING_DT,
INVOICE_CODE AS INVOICE_CD,
...
UPC AS UPC_ID,
UNITS_SOLD AS SOLD_UNITS_QTY,
PRODUCT_COST AS PRODUCT_COST,
RETAIL_PRICE AS RETAIL_PRICE,
MANUFACTURER AS MANUFACTURER,
BRAND AS BRAND_NAME,
TITLE AS TITLE,
FREIGHT_FEE AS FREIGHT_FEE_AMT,
PACKAGING_FEE AS PACKAGING_FEE_AMT,
DISPENSING_FEE AS DISPENSING_FEE_AMT,
SHIPPED_DATE AS SHIPPED_DT,
FULFILLMENT_ORIGIN_ZIP_CODE AS FULFILLMENT_ORIGIN_ZIP_CD,
SHIPPING_CARRIER AS SHIP_CARRIER_NAME,
TRACKING_NUMBER AS TRACKING_NBR,
ALLIVET_CUSTOMER_ID AS ALLIVET_CUSTOMER_NBR,
PET_NAME AS PET_NAME,
PET_TYPE AS PET_TYPE,
BREED_TYPE AS BREED_TYPE,
PET_GENDER AS PET_GENDER,
PET_DOB AS PET_BIRT_DT,
PET_WEIGHT AS PET_WEIGHT,
PET_ALLERGY AS PET_ALLERGY_DESC,
PET_MEDICAL_CONDITIONS AS PET_MEDICAL_CONDITION,
PET_IS_PREGNANT AS PET_PREGNANT_FLAG,
VET_CLINIC_NAME AS VET_CLINIC_NAME,
VETERINARY_NAME AS VET_NAME,
VET_ADDRESS AS VET_ADDRESS,
VET_CITY AS VET_CITY,
VET_STATE AS VET_STATE_CD,
VET_ZIP AS VET_ZIP_CD,
VET_PHONE_NUMBER AS VET_PHONE_NBR,
DELETE_FLAG AS DELETE_FLAG,
UPDATE_TSTMP AS UPDATE_TSTMP,
