...
# COMMAND ----------
# DBTITLE 1, Allivet_Daily_System_Audit_0
...
df_0.createOrReplaceTempView("Allivet_Daily_System_Audit_0")
...
df_2=spark.sql("""
    SELECT
        ...
        ExtraInfo AS ExtraInfo,
        to_date(ChangeDate,
        'MM/DD/YYYY HH12:MI:SSAM') AS o_ChangeDate,
        FromItemCode AS FromItemCode,
        ToItemCode AS ToItemCode,
        AllivetOrderCode AS AllivetOrderCode,
        LineNum AS LineNum,
...
spark.sql("""INSERT INTO ALLIVET_DAILY_SYSTEM_AUDIT_PRE SELECT AllivetOrderCode AS ALLIVET_ORDER_CODE,
