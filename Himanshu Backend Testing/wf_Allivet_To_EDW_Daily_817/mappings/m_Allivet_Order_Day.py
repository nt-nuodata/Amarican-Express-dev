...
df_8=spark.sql("""
    SELECT
        ...
        OR ISNULL(Lkp_ALLIVET_ORDER_LN_NBR)) 
        AND (IFF(ISNULL(ORDER_CREATED_DATE),
        TO_DATE('9999-12-31',
        'YYYY-MM-DD'),
        ORDER_CREATED_DATE) <> IFF(ISNULL(Lkp_ORDER_CREATED_DT),
        TO_DATE('9999-12-31',
        'YYYY-MM-DD'),
        Lkp_ORDER_CREATED_DT) 
        OR IFF(ISNULL(ORDER_MODIFIED_DATE),
        TO_DATE('9999-12-31',
        'YYYY-MM-DD'),
        ORDER_MODIFIED_DATE) <> IFF(ISNULL(Lkp_ORDER_MODIFIED_DT),
        TO_DATE('9999-12-31',
        'YYYY-MM-DD'),
        Lkp_ORDER_MODIFIED_DT) 
        OR IFF(ISNULL(ORDER_DETAIL_CREATED_DATE),
        TO_DATE('9999-12-31',
        'YYYY-MM-DD'),
        ORDER_DETAIL_CREATED_DATE) <> IFF(ISNULL(Lkp_ORDER_DETAIL_CREATED_DT),
        TO_DATE('9999-12-31',
        'YYYY-MM-DD'),
        Lkp_ORDER_DETAIL_CREATED_DT) 
        OR IFF(ISNULL(ORDER_DETAIL_MODIFIED_DATE),
        TO_DATE('9999-12-31',
        'YYYY-MM-DD'),
        ORDER_DETAIL_MODIFIED_DATE) <> IFF(ISNULL(Lkp_ORDER_DETAIL_MODIFIED_DT),
        TO_DATE('9999-12-31',
        'YYYY-MM-DD'),
