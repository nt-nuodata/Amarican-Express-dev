CREATE TABLE IF NOT EXISTS DELTA_TRAINING.ALLIVET_DAILY_INVOICE_PRE_v2_test(INVOICE_POSTING_DATE_v2_test DATE,
INVOICE_CODE STRING,
TRANSACTION_TYPE STRING,
ALLIVET_ORDER_CODE STRING,
ALLIVET_SKU_v2_test STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.ALLIVET_DAILY_ORDER_PRE_v2_test(ALLIVET_ORDER_CODE STRING,
...
INVOICE_CD_v2_test STRING,
TXN_TYPE STRING,
ALLIVET_ORDER_NBR STRING,
ALLIVET_SKU_NBR STRING,
PRODUCT_ID_v2_test INT,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.ALLIVET_DAILY_SYSTEM_AUDIT_PRE_v2_test(ALLIVET_ORDER_CODE STRING,
ALLIVET_ORDER_COUNTER INT,
ALLIVET_ORDER_LINE_NUMBER INT,
OPERATION_v2_test STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.ALLIVET_SYSTEM_AUDIT_DAY_v2_test(ALLIVET_ORDER_NBR STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.ALLIVET_ORDER_DAY_v2_test(ALLIVET_ORDER_NBR_v2_test STRING,
ALLIVET_ORDER_LN_NBR INT,
ALLIVET_ORDER_DT_v2_test DATE,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.ALLIVET_ORDER_STATUS_DAY_v2_test(ALLIVET_ORDER_NBR_v2_test STRING,
RX_HOLD_DT_v2_test DATE,
OPEN_DT_v2_test DATE,
COMPLETE_DT DATE,
VOID_DT_v2_test DATE,
UPDATE_TSTMP TIMESTAMP,
LOAD_TSTMP TIMESTAMP) USING DELTA;