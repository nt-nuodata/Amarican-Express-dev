...
IIF(SALES_AMT <> 0, 1, 0) AS SITE_SALES_FLAG,
sessstarttime AS o_UPDATE_DATE,
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM ASQ_Shortcut_To_SALES_DAY_STORE_2""")
...
null AS CLOSE_DT,
SITE_SALES_FLAG AS SITE_SALES_FLAG,
null AS SALES_CURR_FLAG,
null AS SITE_OPEN_YRS_AMT,
null AS FIRST_SALE_DT,
null AS FIRST_MEASURED_SALE_DT,
null AS LAST_SALE_DT,
null AS COMP_CURR_FLAG,
null AS COMP_EFF_DT,
null AS COMP_END_DT,
null AS TP_LOC_FLAG,
...
null AS LOAD_DT FROM EXP_FLAG_VALUE_LOGIC_3""")
