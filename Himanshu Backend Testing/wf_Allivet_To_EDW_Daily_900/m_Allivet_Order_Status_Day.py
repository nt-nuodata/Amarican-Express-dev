...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_ALLIVET_ORDER_STATUS_DAY1
...
FROM
  ALLIVET_ORDER_STATUS_DAY_V2_test""")

df_0.createOrReplaceTempView("Shortcut_to_ALLIVET_ORDER_STATUS_DAY1_0")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_ALLIVET_ORDER_STATUS_DAY
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_ALLIVET_ORDER_DAY
...
# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_ALLIVET_ORDER_DAY
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_ALLIVET_INVOICE_DAY
...
df_4 = spark.sql("""SELECT
  ...
  LOAD_TSTMP AS LOAD_TSTMP
FROM
  ALLIVET_INVOICE_DAY_V2_test""")

df_4.createOrReplaceTempView("Shortcut_to_ALLIVET_INVOICE_DAY_4")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_ALLIVET_INVOICE_DAY
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_ALLIVET_SYSTEM_AUDIT_DAY
...
df_6 = spark.sql("""SELECT
  ...
  LOAD_TSTMP AS LOAD_TSTMP
FROM
  ALLIVET_SYSTEM_AUDIT_DAY_V2_test""")

df_6.createOrReplaceTempView("Shortcut_to_ALLIVET_SYSTEM_AUDIT_DAY_6")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_ALLIVET_SYSTEM_AUDIT_DAY
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_ALLIVET_ORDER_STATUS_DAY


spark.sql("""MERGE INTO ALLIVET_ORDER_STATUS_DAY_V2_test AS TARGET
USING
