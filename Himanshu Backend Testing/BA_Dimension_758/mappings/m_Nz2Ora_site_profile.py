...
# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_SITE_PROFILE1_1
...
df_1.createOrReplaceTempView("SQ_Shortcut_to_SITE_PROFILE1_1")
...
DELETE_DT AS DELETE_DT,
UPDATE_DT AS UPDATE_DT,
LOAD_DT AS LOAD_DT FROM SQ_Shortcut_to_SITE_PROFILE1_1""")