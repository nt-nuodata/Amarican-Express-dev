    ...
    FROM
        ...
        FROM
            ...
            FROM
                EMPLOYEE_PROFILE_DAY_PSOFT 
            WHERE
                DAY_DT > CAST('20101128' AS TIMESTAMP)
        ) T 
    WHERE
        DAY_DT = (
            (
...
# DBTITLE 1, EMPL_36HR_FLAG

spark.sql("""INSERT INTO EMPL_36HR_FLAG SELECT E3.PERIOD_DT AS WEEK_DT,
E3.EMPLOYEE_ID AS EMPLOYEE_ID,
E3.LOCATION_ID AS LOCATION_ID,
ERNSC4.out_HOURS_WORKED_COST AS EMPL_13WK_AVG_HRS_WORKED,
E3.Flag AS FLAG,
null AS LOAD_TSTMP FROM EXPTRANS_3 E3 INNER JOIN EXP_ROUND_NET_SALES_COST_4 ERNSC4 ON E3.Monotonically_Increasing_Id = ERNSC4.Monotonically_Increasing_Id """)
